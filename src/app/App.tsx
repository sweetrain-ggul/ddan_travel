...
import { loadSettings, normalizeSettings, saveSettings } from "../domain/storage";
...
function createDefaultSettings(): AppSettings {
  return {
    ...
    rates: {
      VND: { code: "VND", unit: 100, krwPerUnit: 6, updatedAt: Date.now() },
...
export function App() {
  const [settings, setSettings] = useState<AppSettings>(() => normalizeSettings(loadSettings() ?? createDefaultSettings()));
